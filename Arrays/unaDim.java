...
public class unaDim {
    ...
    // //declaramos una array de 5 alunos de manera estatica
    ...
    public static void generarNotas() {
        ...
        System.out.println("Max :  " + max + "Del Alumno: " + unaDim.alumnos[pmax]);
        System.out.println("Min :  " + min + "Del Alumno: " + unaDim.alumnos[pmin]);
