...
public class Prueba01 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int n = Prueba01.entrada.nextInt();
        System.out.println("La suma es: "+ Prueba01.sumarN(n));
        System.out.println("El factorial es: "+ Prueba01.factorialN(n));
    ...
    public static void clear(){
      ...
      char n = Prueba01.entrada.next().toLowerCase().charAt(0);
      if (n == 's'){
